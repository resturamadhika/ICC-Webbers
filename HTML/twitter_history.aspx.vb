...
Public Class twitter_history
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            While sqldr.Read()
                valTwitHst &= "<tr>" & _
                              "<td><span class='not-starred'><a class='nonelink' href='twitter_history.aspx?detail=" & sqldr("IVC_ID") & "&account=" & sqldr("EFROM") & "' target='_blank'>Replay</a></span></td>" & _
