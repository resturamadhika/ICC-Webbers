<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HTML/Ticket.Master" CodeBehind="fax.aspx.vb" Inherits="Helpdesk_Application.fax" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="padding-sm">        
        ...
        <div class="row" id="fax_TableSend" runat="server">
            ...
            <div class="col-md-9" id="Fax_table" runat="server" visible="true">
                <div class="clearfix">
