<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HTML/Ticket.Master" CodeBehind="inbox.aspx.vb" Inherits="Helpdesk_Application.inbox" %>
                        ...
                        <a href="inbox.aspx?status=pending" data-toggle="modal" id="modal_ticket_pending" runat="server">
                            <div class="panel panel-default panel-stat2 bg-info">
                                <div class="panel-body">
                                    ...
                                    <div class="pull-right text-right">
                                        <div class="value">
                                            <asp:Label ID="lbl_pending" runat="server" ForeColor="White" Text="0"></asp:Label>
                                        </div>
                                        <div class="title">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="pull-right text-right">
                                        <div class="value">
                                            ...
                                            <asp:Label ID="lbl_on_progress" runat="server" ForeColor="White" Text="0"></asp:Label>

                                        </div>
                                        <div class="title">
                                            <asp:Label ID="Label3" runat="server" ForeColor="White" Text="Ticket On Progress"></asp:Label>
                                        </div>
                                    </div>
                    ...
                    <table class="table table-striped" id="tbl_todolist">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 150px;">Acount</th>
                                <th>Message</th>
                                <%--  <th>Channel</th>--%>
