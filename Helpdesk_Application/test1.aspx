<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="test1.aspx.vb" Inherits="Helpdesk_Application.test1" %>
...
<body class="overflow-hidden">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <span class="badge badge-info pull-right">4 left
								</span>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">IN-STORE Sales
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">DOWMLOAD Sales
												</a>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">MAIL-ORDER Sales 
    ...
    <!-- Morris -->
    <script src="HTML/js/rapheal.min.js"></script>
    <script src="HTML/js/morris.min.js"></script>
    <!-- Colorbox -->
    <script src="HTML/js/jquery.colorbox.min.js"></script>
    <!-- Sparkline -->
    <script src="HTML/js/jquery.sparkline.min.js"></script>
    <!-- Pace -->
    <script src="HTML/js/uncompressed/pace.js"></script>
    <!-- Popup Overlay -->
    ...
    <!-- Endless -->
    <script src="HTML/js/endless/endless_dashboard.js"></script>
