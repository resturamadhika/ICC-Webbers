...
Public Class add_user
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        sql_add_user.SelectCommand = "select a.NIK,a.UserName,a.Password,a.LevelUser as LevelUser ,a.UserId,a.UnitKerja from msUser a left outer join msleveluser b on a.LevelUser=b.Name order by a.UserName Asc"
