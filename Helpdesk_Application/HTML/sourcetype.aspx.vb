...
Public Class sourcetype
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sql_source_type.InsertCommand = "insert into mSourceType (TypeID, Name, TicketIDCode, NA, UserCreate, DateCreate) values (@TypeID, @Name, @TicketIDCode, @NA, 'UserCreate', getdate())"
