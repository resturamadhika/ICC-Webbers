<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HTML/Ticket.Master" CodeBehind="status.aspx.vb" Inherits="Helpdesk_Application.status" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="div_status" runat="server">
        ...
        <div class="padding-md">
          <div class="row">
                <dx:ASPxGridView ID="gv_status" runat="server" KeyFieldName="id"
                    DataSourceID="sql_status" Width="100%" Theme="MetropolisBlue">
                    <SettingsPager>
                        <AllButton Text="All">
                        </AllButton>
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="ID" FieldName="id"  ReadOnly="true" Width="50px" 
